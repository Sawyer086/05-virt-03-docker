...
### 11
Исправляем ситуацию не пересоздавая контейнер. Необходимо внести правки вручную в конфигурационные файлы hostconfig.json и config.v2.json.
...
![1](https://github.com/Sawyer086/05-virt-03-docker/blob/main/3/3.4(11).jpg)
![2](https://github.com/Sawyer086/05-virt-03-docker/blob/main/3/3.5(11).jpg)
